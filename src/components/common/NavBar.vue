<template>
  <div class="e-container">
    <div class="nav-wrapper">
      ...
      <!--  Nav-Bar 点击区域  -->
      <nav
        class="navbar navbar-expand-lg navbar-dark right-model"
        :class="isHome ? '' : 'navbar-no-home'"
      >
        <button
          class="navbar-toggler mobile-navbar-btn"
          type="button"
        ...
        <div
          class="collapse navbar-collapse navbar-collapse-mobile"
        ...
        >
          ...
          <ul class="navbar-nav" :class="isHome ? '' : 'navbar-nav-no-home'">
            ...
            <li class="nav-item">
              <a class="nav-link" :href="nodelist" target="_blank"
            ...
            <li class="nav-item">
              <a class="nav-link" @click="toContractList"
            ...
            <li class="nav-item">
              <a class="nav-link" @click="toOntIdListPage"
