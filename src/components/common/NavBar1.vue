<template>
  <div class="e-container">
    <div class="row">
      ...
      <!--  Nav-Bar 点击区域  -->
      <nav
        class="navbar navbar-expand-lg navbar-dark col-12 padding-lr0"
        :class="isHome ? '' : 'navbar-no-home'"
      >
        <button
        ...
        >
          ...
          <ul
            class="navbar-nav  navbar-center  padding-right0 col-8"
            :class="isHome ? '' : 'navbar-nav-no-home'"
          >
            <li class="nav-item dropdown">
              ...
              >
                ...
                <img
                  v-if="isHome"
                  src="../../assets/navbar/lian@2xM.png"
                  class="nav-link-icon"
                />
                <img
                  v-else
                  src="../../assets/navbar/lian@2x.png"
                  class="nav-link-icon"
                />
              ...
              <div class="dropdown-menu">
                ...
                <a class="dropdown-item" @click="toBlockListPage"
                  ><!-- <i class="fas fa-th"></i>&nbsp;&nbsp; -->{{
                    $t("navbar.top.blocks")
                  }}</a
                >
                <hr style="margin: 4px 1rem" />
                <a class="dropdown-item" @click="toTransactionListPage"
                  ><!-- <i class="fas fa-exchange-alt"></i>&nbsp;&nbsp; -->{{
                    $t("navbar.top.txns")
                  }}</a
                >
                <hr
                  v-if="$route.params.net !== 'testnet'"
                  style="margin: 4px 1rem"
                />
                <!-- <a v-if="$route.params.net !== 'testnet' " class="dropdown-item" @click="toAddressList">{{ $t('navbar.top.accounts') }}</a> -->
              </div>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link padding-lr0" :href="nodelist" target="_blank">
                <img
                  v-if="isHome"
                  src="../../assets/navbar/nodes@2xM.png"
                  class="nav-link-icon"
                />
                <img
                  v-else
                  src="../../assets/navbar/nodes@2x.png"
                  class="nav-link-icon"
                />
            ...
            <!-- <li class="nav-item dropdown">
              ...
              >
                <img
                  v-if="isHome"
                  src="../../assets/navbar/token@2xM.png"
                  class="nav-link-icon"
                />
                <img
                  v-else
                  src="../../assets/navbar/token@2x.png"
                  class="nav-link-icon"
                />
                {{
                  $t("navbar.top.tokens")
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" @click="toTokenList('oep4')"
                  >{{
                    $t("navbar.top.oep4")
                  }}</a
                >
                <hr style="margin: 4px 1rem" />
                <a class="dropdown-item" @click="toTokenList('oep5')"
                  >{{
                    $t("navbar.top.oep5")
                  }}</a
                >
                <hr style="margin: 4px 1rem" />
                <a class="dropdown-item" @click="toTokenList('oep8')"
                  >{{
                    $t("navbar.top.oep8")
                  }}</a
                >
                <hr style="margin: 4px 1rem" />
                <a class="dropdown-item" @click="toTokenSubmit('submit')"
                  >{{
                    $t("navbar.top.submit")
                  }}</a
                >
            ...
            <!-- <li class="nav-item">
              <a class="nav-link padding-lr0" @click="toContractList">
                <img
                  v-if="isHome"
                  src="../../assets/navbar/Contracts@2xM.png"
                  class="nav-link-icon"
                />
                <img
                  v-else
                  src="../../assets/navbar/Contracts@2x.png"
                  class="nav-link-icon"
                />
                {{
                  $t("navbar.top.contracts")
                }}</a
              >
            </li> -->
            ...
            <li class="nav-item">
              <a class="nav-link padding-lr0" @click="toOntIdListPage">
                <img
                  v-if="isHome"
                  src="../../assets/navbar/ontid@2xM.png"
                  class="nav-link-icon"
                />
                <img
                  v-else
                  src="../../assets/navbar/ontid@2x.png"
                  class="nav-link-icon"
                />
            ...
            <!-- <li class="nav-item dropdown">
              ...
              >
                <img
                  v-if="isHome"
                  src="../../assets/navbar/tools@2xM.png"
                  class="nav-link-icon"
                />
                <img
                  v-else
                  src="../../assets/navbar/tools@2x.png"
                  class="nav-link-icon"
                />
                {{ $t("navbar.top.tool") }}
              </a>
              <div class="dropdown-menu">
                <a
                  class="dropdown-item"
                  target="_blank"
                  :href="$t('navbar.top.apiDocUrl')"
                  >{{ $t("navbar.top.apis") }}</a
                >
                <hr style="margin: 4px 1rem" />
                <a class="dropdown-item" @click="toStatistics">{{
          ...
          <ul
            class="navbar-nav col-2 navbar-right"
            :class="isHome ? '' : 'navbar-nav-no-home'"
          >
            <li class="nav-item dropdown ">
              <a
                v-if="$t('navbar.flag') === 'zh'"
                class="nav-link nav-link-r dropdown-toggle padding-lr0"
                data-toggle="dropdown"
                href="#"
              >
              ...
              <div class="dropdown-menu">
                <a
                  class="dropdown-item"
                  :class="$t('navbar.flag') === 'zh' ? '' : 'pointer-events'"
                  href="#"
            ...
            <li class="nav-item dropdown ">
              <a class="nav-link nav-link-r padding-lr0" href="#">
                {{ $t("navbar.top.mainNet") }}
              </a>
              <!-- <a
                v-if="$route.params.net === 'testnet'"
                class="nav-link nav-link-r dropdown-toggle padding-lr0"
              ...
              <!-- <div class="dropdown-menu">
                <a
                  class="dropdown-item"
                  :class="
                    $route.params.net === 'testnet' ? '' : 'pointer-events'
                  "
                  href="#"
                  @click="changeNet()"
                  >{{
  ...
  methods: {
    ...
    chooseLanguage($lang) {
      ...
      if (
        ...
        this.$route.name == "StatisticsTest"
      ) {
