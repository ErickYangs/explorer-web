  ...
  <div class="e-container div-run-status">
    <div class="row">
      ...
      <div class="col col-click" @click="toTransactionListPage">
        ...
        <span class="d-block run-status-p font-ExtraLight font-size48">
          <span>{{
            $HelperTools.toFinancialVal(blockStatus.info.tx_count)
          }}</span>
        </span>
      </div>
      <div
        ...
        <span class="d-block run-status-p font-ExtraLight font-size48">
          <span>{{
            $HelperTools.toFinancialVal(
              nodeCount.info.candidate_node_count +
                nodeCount.info.consensus_node_count
            )
          }}</span>
        </span>
      </div>
      ...
      <div class="col col-click" @click="toOntIdListPage">
        ...
        <span class="d-block run-status-p font-ExtraLight font-size48">
          <span>{{
            $HelperTools.toFinancialVal(blockStatus.info.ontid_count)
          }}</span>
        </span>
      </div>
    </div>
