module.exports = {
  ...
  nodes: {
    ...
    website: "Website:",
    guideTxt:
      "To participate stake authorization, find the step-by-step guide ",
    here: "here.",
    tooltipTit:
      "This is the portion of rewards received the node has chosen to share with users who have authorized stakes with them in the next consensus round.",
  ...
  tokens: {
    ...
    detail: {
      ...
      tip:
        "Please note: Here is daily cumulative statistics, there is up to 10 minutes statistical difference."
    }
  },
  statistics: {
